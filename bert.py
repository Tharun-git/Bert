...
Original file is located at
    https://colab.research.google.com/drive/13x3j9mKknBK-e0pdZEbTZqJir-wOCDCu
...
While feature-based
approaches such as ELMo [3]  are effective
...
# change `ctx` to `mx.ppu()` if GPU is available.
ctx = mx.cpu(0)
